...
public class Task {
    ...
    public void setName(String name) { if (name != null && name.length() <= 20) this.name = name; }
    public String getDescription() { return description; }
    public void setDescription(String description) { if (description != null && description.length() <= 50) this.description = description; }
}
